...
- A-E only differ in depth 
    ![ConfigAtoE](pics_11_22/configAtoE.png)
    ![numParams](pics_11_22/numParams.png)
...
- Obtaining fixed-size 224 x 224 ConvNet input image
    ...
    - Training image rescaling
        ...
        - Setting training scale S #2: multi-scale training
            ...
            - Ex
                ![deer S = 256](pics_11_22/deer256.png)
...
![multi scale eval](pics_11_22/multipleTestScale.png)
- Scale jittering
